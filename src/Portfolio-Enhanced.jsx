...
const personalInfo = {
  ...
  title: "Performance Marketer | Shopify Developer | E-commerce Expert | +8 Google Certifications in Digital Marketing & E-commerce",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto text-center">
            <Card>
              <CardContent>
                ...
                <p className="text-5xl font-mono font-bold text-white flex justify-center"><AnimatedCounter value={5.000.000} /></p>
              </CardContent>
            </Card>
            <Card>
              <CardContent>
