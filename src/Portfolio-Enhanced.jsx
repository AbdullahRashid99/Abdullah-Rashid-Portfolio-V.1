...
// - Click/tap opens zoom (desktop + mobile), but doesn't open while dragging
// - Hover zoom on desktop (stops slider while hovering)
// - Native drag/scroll supported
// - Dots + Play/Pause only (no bottom scrollbar shown)
// -------------------------
