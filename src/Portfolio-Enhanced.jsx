// Portfolio.jsx — Clean & Fixed
// - WatermarkWrapper duplicate removed (was causing build error)
// - Raw HTML removed from footer
// - No PromoBanner (removed as requested)
